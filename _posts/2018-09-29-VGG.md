...
By the way, transfer learning can be applied to extract features of an image. For example, leverage part of a pre-trained AlexNet model to extract the lower-layer features of an image and then redesign the rest part of the model.
